...
\newglossaryentry{pm-gls}
{
    ...
    description={
        ...
        zurücksetzen/löschen und die Firmware-Versionen verwalten. Außerdem ist er der nächste
        Ansprechpartner für den \acrshort{ts} bei Problemen, die dieser nicht lösen kann}
}
